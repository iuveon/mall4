...
public class ReviewControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/review/register")
			.param("b_title", "controller.testRegister() 테스트 제목")
			.param("b_content", "controller.testRegister() 테스트 내용")
			.param("b_writer", "id1"))
	...
	public void testGet() throws Exception {
		...
		ModelMap resultPage = mockMvc.perform(MockMvcRequestBuilders.get("/review/get")
				.param("b_num", "9"))
				.andReturn().getModelAndView().getModelMap();
	...
	public void testModify() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/review/modify")
				.param("b_num", "9")
				.param("b_title", "controller.testModify() 테스트 제목")
				.param("b_content", "controller.testModify() 테스트 내용")
				.param("b_writer", "id1"))
				.andReturn().getModelAndView().getViewName();
