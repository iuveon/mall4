		    	...
		    	<div class="panel-heading mb-5">
		      	...
		      	<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="/product/get?p_num=<c:out value="${ProductVO.p_num }"/>">
								<img src="../../../../resources/images/product-1.jpg" class="img-fluid product-thumbnail">
								<h3><c:out value="${ ProductVO.p_name}"></c:out></h3>
								<strong><c:out value="${ ProductVO.p_price}"></c:out></strong>
